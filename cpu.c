...
{
    // Decode and execute the instruction using ugly giant switch
    // In first place, only the most significant byte is used to identify the opcode or the group of opcodes
    // When the most significant byte is not enough to identifty the opcode, the rest are used
